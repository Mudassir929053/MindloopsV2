...
<head>
    <link rel="stylesheet" href="assets/games/Sudoku/css/app.css">
    <style>
        body {
            background: url('assets/games/Sudoku/images/background_image.png') no-repeat center center fixed;
        ...
        .btn-bg-easy {
            background-image: url("assets/games/Sudoku/images/easy.png");
        ...
        .btn-bg-medium {
            background-image: url("assets/games/Sudoku/images/medium.png");
            background-size: contain;
            background-repeat: no-repeat;
            background-position: center;
            border: none;
        ...
        .btn-bg-hard {
            background-image: url("assets/games/Sudoku/images/hard.png");
            background-size: contain;
            background-repeat: no-repeat;
            background-position: center;
            border: none;
        ...
        .btn-bg-newgame {
            background-image: url("assets/games/Sudoku/images/new_game.png");
            background-size: contain;
            background-repeat: no-repeat;
            background-position: center;
            border: none;
        ...
        .btn-bg-resume {
            background-image: url("assets/games/Sudoku/images/resume.png");
            background-size: contain;
            background-repeat: no-repeat;
            background-position: center;
            border: none;
...
<body>
    <div class="bg-image pt-2 text-center shadow-1-strong rounded text-white">
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-1 col-md-4 col-sm-4 mb-3 pt-md-5 mb-md-0">
                    <a class="thumbnail" href="suduko_index">
          ...
          <img src="../../assets/games/Sudoku/continue.png" class="img-fluid rounded" alt="...">
                            ...
                            <div class="col-md-6 col-sm-6 mb-3 mb-md-0">
                                <a class="thumbnail" id="btn-play">
                                    <img src="assets/games/Sudoku/images/new_game.png" class="img-fluid rounded" alt="...">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/games/Sudoku/static/js/constant.js"></script>
    <script src="assets/games/Sudoku/static/js/sudoku.js"></script>
    <script src="assets/games/Sudoku/static/js/app.js"></script>
