...
if (!isset($_SESSION['score'])) {
    echo "<script>window.location.href = 'loops-next_quiz.php?game=tfq';</script>";
}
$_SESSION['attemptedq'] = [];
// var_dump($_SESSION);
// exit;
  ...
  <main style="background-image: url('assets/Quizes/mcq/images/Instruction.png');background-repeat:no-repeat; background-position: center; height: 800px;">
    <div class="container py-5 font"><br><br><br><br><br><br><br><br><br><br>
      ...
      <div class="text-center mt-4">
        <a href="loops-next_quiz?game=tfq" class="btn"><img src="assets/Quizes/mcq/images/start1.png" height="55px"></a>
