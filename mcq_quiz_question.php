...
$total = "SELECT * FROM questions WHERE category_id=$category_id AND status='1'";
  ...
  <main>
      ...
      <div class="container">
        <div class="border-secondary mb-3">
          ...
          <div class="card-body" style="background-image: url('assets/Quizes/mcq/images/border_question.png'); background-repeat: no-repeat; background-size: 100% 40%;  padding: 25px;"><br><br>
            ...
            <form method="post" action="mcq_quiz_proces?category_id=<?= $category_id ?>">
    ...
    <?php } 
        ...
        echo '<script>
            ...
            window.location.href = "loops-next_quiz?game=mcq";
        </script>';
    }
    ?>
  </main>
