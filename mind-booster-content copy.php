                                        ...
                                        <div class="m-2 bg-white">
                                            <div class="row bg-white">
                                                <div class="col-lg-5 col-md-12">
                                                    ...
                                                    <img src="<?= BASE_URL ?>/assets/uploads/lesson/<?php echo $images; ?>" loading="lazy" class="img-fluid rounded" alt="Image" style="object-fit: cover; height:90%;">
                                                </div>
