    ...
    <?php
    extract($_GET);
    $query = "SELECT qno FROM questions WHERE category_id=$category_id AND status='1'";
...
<main style="background-image: url('assets/Quizes/mcq/images/Instruction.png');background-repeat:no-repeat; background-position: center 200px; height: 800px;">
    <div class="container py-5 font"><br><br><br><br><br><br><br><br><br><br><br>
      ...
      <div class="text-center mt-4">
        <a href="mcq_quiz_question.php?category_id=<?php echo $category_id; ?>" class="btn" onclick="playGames(this)" data-level="<?= $category;  ?>"><img id="shake" src="assets/Quizes/mcq/images/start1.png" height="55px"></a>
        <a href="loops-next_quiz?game=mcq" class="btn"><img src="assets/Quizes/mcq/images/exit1.png" height="50px"></a>
      </div>
    </div>
  </main>
</body>
