...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/games/crossword/style.css">
...
<style>
    body {
  background: url('<?= BASE_URL ?>/assets/games/crossword/Asset 17.png') no-repeat center center fixed;
...
<body>
    <div class="bg-image p-5 text-center shadow-1-strong rounded text-white" >
      ...
      <div class="row  align-items-center">
        <div class="col-lg-1 col-md-4 col-sm-4 mb-3 mb-md-0">
          <a class="thumbnail" href="loops-next?game=Crossword">
            <img src="<?= BASE_URL ?>/assets/games/crossword/Asset 61.png" class="img-fluid rounded" alt="...">
          </a>
        </div>
        <!-- <div class="col-lg-10 col-md-4 col-sm-4 mb-3 mb-md-0">
          <a class="thumbnail" href="crossword.php">
            <img src="<?= BASE_URL ?>/assets/games/Crossword/Asset 131.png" class="img-fluid rounded" alt="...">
          </a>
        </div> -->
        <div class="col-lg-1 offset-lg-10 offset-md-4 col-md-4 col-sm-4 ">
          <a class="thumbnail" data-bs-toggle="modal" data-bs-target="#exampleModal123">
            <img src="<?= BASE_URL ?>/assets/games/crossword/Asset 62.png" class="img-fluid rounded" alt="...">
          </a>
        </div>
    ...
    <?php
    $cc_id = $_GET['category_id'];
    // Retrieve data from "crossword_clue" table
    $sql = "SELECT * FROM `crossword_clue` 
LEFT JOIN game_category ON crossword_clue.cc_id = game_category.category_id 
