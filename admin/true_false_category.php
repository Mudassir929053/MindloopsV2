                ...
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                        <div class="mb-3 mb-md-0">
                            <h1 class="mb-1 h2 fw-bold">Quizes Category</h1>
                        </div>
                        <div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-md">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" class="form-control" id="tf" name="tf" value="T/F">
                                    <!-- Title -->
                                    <div class="mb-3">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr class="align-middle">
                                                ...
                                                <td><img src="../assets/uploads/mcq_category_image/<?php echo $row["category_image"]; ?>" width="100" height="80"></td>
                                                <td>
                                                    <?php
                                                ...
                                                <td class="text-center ">
                                                    <a class="btn btn-sm btn-secondary text-white" href="true_false.php?category_id=<?php echo $row["category_id"]; ?>">
                                                        View Questions
                                                    </a>
